		...
		<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
			...
			<div class="d-flex align-items-center flex-wrap mr-1">
				...
				<div class="d-flex align-items-baseline flex-wrap mr-5">
					<!--begin::Page Title-->
					<h5 class="text-dark font-weight-bold my-1 mr-5">{{$single_user_data[0]['name']}}</h5>
					<!--end::Page Title-->
					<!--begin::Breadcrumb-->
						...
						<div class="card-body pt-4">
							...
							<div class="d-flex align-items-center">
								<div class="symbol symbol-60 symbol-xxl-100 mr-5 align-self-start align-self-xxl-center">
									<?php 
									$number = $single_user_data[0]['id'];
									$gender = $single_user_data[0]['gender'];
									$country = $single_user_data[0]['country'];
									$image_num = rand(11, 20);
									$username_ = $single_user_data[0]['name'];
				                    $Substring = substr($username_ , 0,1);
				                    $show_str = 0 ;

									/* if ($gender == 'female') {
			                             $image_num = 'female' . '.jpg';
			                        }else{
			                            if ($country == "Bangladesh") {
			                                $image_num = $number . '.jpg';
				                            }else{
				                                 $show_str = 1;
				                            }
			                        } */
									?>
									<?php if ($single_user_data[0]['profile_img_url'] != ''): ?>
										
									<div class="symbol-label" style="">
										<img width="100" height="100" class="symbol flex-shrink-0"src="{{asset($single_user_data[0]['profile_img_url'])}}" alt="{{$single_user_data[0]['name']}}">
									</div>
									<?php else :?>

									<div class="symbol symbol-40 symbol-light-success flex-shrink-0"> 
										<!-- <span class="symbol-label font-size-h4 font-weight-bold"><?php echo $Substring; ?></span> -->
										<span class="symbol-label display-3 font-weight-boldest">@php
										// echo Str::substr($username_, 0, 1)
										// $words = explode(" ", $single_user_data[0]['name']);
										// dd($words);
										$acronym = '';
										if(preg_match_all('/\b(\w)/',strtoupper($username_),$m)) {
								...
								<div>
									<a href="#" class="font-weight-bolder font-size-h5 text-dark-75 text-hover-primary">{{$single_user_data[0]['name']}}</a>
									<div class="text-muted">{{$single_user_data[0]['professions']}}</div>
									<div class="mt-2">
							...
							<div class="py-9">
								<div class="d-flex align-items-center justify-content-between mb-2">
									...
									<a href="#" class="text-muted text-hover-primary">{{$single_user_data[0]['email']}}</a>
								</div>
								<div class="d-flex align-items-center justify-content-between mb-2">
									<span class="font-weight-bold mr-2">Phone:</span>
									<span class="text-muted">{{$single_user_data[0]['phone']}}</span>
								</div>
								<div class="d-flex align-items-center justify-content-between">
									<span class="font-weight-bold mr-2">Location:</span>
									<span class="text-muted">{{$single_user_data[0]['country']}}</span>
								</div>
							</div>
							<!--end::Contact-->
							<!--begin::Nav-->
							...
							<div class="card card-custom gutter-b">
								<div class="card-header">
									<div class="card-title">
										<h3 class="card-label">Location Map</h3>
									</div>
								</div>
								<div class="card-body">
									<div id="user_gmap" style="height:300px;"></div>
								</div>
							</div>
						<!--end::Card-->
						</div>
							...
							<div class="card card-custom card-stretch gutter-b">
								...
								<div class="card-body pt-2">
									...
									<div class="d-flex flex-wrap align-items-center mb-10">
										<!--begin::Symbol-->
										<div class="symbol symbol-60 symbol-2by3 flex-shrink-0 mr-4">
											<div class="symbol-label" style="background-image: url({{asset('media/stock-600x400/img-10.jpg')}})"></div>
										</div>
										<!--end::Symbol-->
										<!--begin::Title-->
										<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pr-3">
									...
									<div class="d-flex flex-wrap align-items-center mb-10">
										<!--begin::Symbol-->
										<div class="symbol symbol-60 symbol-2by3 flex-shrink-0 mr-4">
											<div class="symbol-label" style="background-image: url({{asset('media/stock-600x400/img-1.jpg')}})"></div>
										</div>
										<!--end::Symbol-->
										<!--begin::Title-->
									...
									<div class="d-flex flex-wrap align-items-center mb-10">
										<!--begin::Symbol-->
										<div class="symbol symbol-60 symbol-2by3 flex-shrink-0 mr-4">
											<div class="symbol-label" style="background-image: url({{asset('media/stock-600x400/img-9.jpg')}})"></div>
										</div>
										<!--end::Symbol-->
										<!--begin::Title-->
										<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pr-3">
									...
									<div class="d-flex flex-wrap align-items-center">
										<!--begin::Symbol-->
										<div class="symbol symbol-60 symbol-2by3 flex-shrink-0 mr-4">
											<div class="symbol-label" style="background-image: url({{asset('media/stock-600x400/img-12.jpg')}})"></div>
										</div>
										<!--end::Symbol-->
										<!--begin::Title-->
										<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pr-3">
...
@endsection
@php
	$long_lat_ar = explode(",", $single_user_data[0]['long_lat']);
	$zoom = '';
	if(array_key_exists(1, $long_lat_ar)){
		$long_lat = $long_lat_ar;
		$zoom = '15';
	}else{
		$long_lat = ['24.7136', '46.6753'];
		$zoom = '10';
	}
@endphp
...
@if(array_key_exists(1, $long_lat ))
<script>
	jQuery(document).ready(function() {
		...
		var map_init = function() {
			var map = new GMaps({
				div: '#user_gmap',
				lat: '<?php echo $long_lat[0]; ?>',
				lng: '<?php echo $long_lat[1]; ?>',
				zoom: @php echo $zoom; @endphp
			});
			map.addMarker({
				lat: '<?php echo $long_lat[0]; ?>',
				lng: '<?php echo $long_lat[1]; ?>',
				infoWindow: {
						content: '<p><?php echo $single_user_data[0]["address1"]; ?></p>',
					}
				});
