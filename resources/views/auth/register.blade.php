                             ...
                             @csrf
								...
								<div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
									...
									<div class="form-group">
										...
										<input id="name" type="text" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6 rounded-lg font-size-h6 @error('name') is-invalid @enderror" placeholder="Full Name" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
										@error('name')
									...
									<div class="form-group">
										...
										<input id="tel" type="text" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6 @error('phone') is-invalid @enderror" placeholder="phone" name="phone" value="{{ old('phone') }}" required autocomplete="phone" autofocus>
										@error('phone')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
									...
									<div class="form-group">
										...
										<input id="email" type="email" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6 rounded-lg font-size-h6 @error('email') is-invalid @enderror" name="email" placeholder="Email" value="{{ old('email') }}" required autocomplete="email">
                                        @error('email')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
									...
									<div class="form-group">
                                        ...
                                        <input id="password" type="password" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6 rounded-lg font-size-h6 @error('password') is-invalid @enderror" name="password" placeholder="Password" required autocomplete="new-password" >
                                        @error('password')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
									...
									<div class="form-group">
										<label class="font-size-h6 font-weight-bolder text-dark">Password</label>
										<input id="password-confirm" type="password" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6 rounded-lg font-size-h6" placeholder="Confirm password" name="password_confirmation" required autocomplete="new-password">
									...
									<div class="row">
										<div class="col-xl-6">
											...
											<div class="form-group">
												...
												<input id="address_1" type="text" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6  @error('address1') is-invalid @enderror" name="address1" placeholder="Address Line 1" />
												@error('address1')
		                                            <span class="invalid-feedback" role="alert">
		                                                <strong>{{ $message }}</strong>
		                                            </span>
										...
										<div class="col-xl-6">
											...
											<div class="form-group">
												...
												<input id="address_2" type="text" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="address2" placeholder="Address Line 2" />
											</div>
											<!--end::Input-->
										</div>
									</div>
									...
									<div class="row">
										<div class="col-xl-6">
											...
											<div class="form-group">
												...
												<input id="postcode" type="text" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="postcode" placeholder="Postcode"  />
											</div>
											<!--end::Input-->
										</div>
										<div class="col-xl-6">
											...
											<div class="form-group">
												...
												<input id="city" type="text" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="city" placeholder="City"  />
											</div>
											<!--end::Input-->
										</div>
									</div>
									...
									<div class="row">
										<div class="col-xl-6">
											...
											<div class="form-group">
												...
												<input id="state" type="text" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="state" placeholder="State" />
										...
										<div class="col-xl-6">
											...
											<div class="form-group">
												...
												<select id="country_list" name="country" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6">
								...
								<div class="pb-5" data-wizard-type="step-content">
									...
									<div class="form-group">
										...
										<select id="delivery" name="delivery" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6">
									...
									<div class="form-group">
										...
										<select id="packaging" name="packaging" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6">
									...
									<div class="form-group">
										...
										<select id="preferreddelivery" name="preferreddelivery" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6">
								...
								<div class="pb-5" data-wizard-type="step-content">
									...
									<!--begin::Section-->
								<script>
								document.getElementById("password-confirm").onchange = function() {
								  var name = document.getElementById("name").value;
								  var lname = document.getElementById("lname").value;
								  var tel = document.getElementById("tel").value;
								  var email = document.getElementById("email").value;
								  document.getElementById("show_name").innerHTML = name +' '+ lname;
								  document.getElementById("show_phone").innerHTML = tel;
								  document.getElementById("show_email").innerHTML = email;
								};
								

								document.getElementById('address_1').onchange = function() {
								  var address_1 = document.getElementById("address_1").value;
								  document.getElementById("show_address_1").innerHTML = address_1;
								};

								document.getElementById('address_2').onchange = function() {
								  var address_2 = document.getElementById("address_2").value;
								  document.getElementById("show_address_2").innerHTML = address_2;
								};
								...
								document.getElementById('postcode').onchange = function() {
								  ...
								  document.getElementById("show_postcode").innerHTML = postcode+',';
								};
								...
								document.getElementById('country_list').onchange = function() {
								  ...
								  document.getElementById("show_country").innerHTML = country_list;
								};

								document.getElementById('delivery').onchange = function() {
								  var delivery = document.getElementById("delivery").value;
								  document.getElementById("show_delivery_type").innerHTML = delivery;
								};
								document.getElementById('packaging').onchange = function() {
								  var packaging = document.getElementById("packaging").value;
								  document.getElementById("show_packaging").innerHTML = packaging;
								};
								document.getElementById('preferreddelivery').onchange = function() {
								  var preferreddelivery = document.getElementById("preferreddelivery").value;
								  document.getElementById("show_preferreddelivery").innerHTML = preferreddelivery;
								};
								</script>
									...
									<div class="text-dark-50 font-weight-bold line-height-lg mb-8">
										<div id="show_address_1"></div>
										<div id="show_address_2"></div>
										<div >
											<span id="show_city"></span>
											<span id="show_postcode"></span>
									...
									<div class="text-dark-50 font-weight-bold line-height-lg mb-8">
										<div id="show_delivery_type"></div>
										<div id="show_packaging"></div>
										<div id="show_preferreddelivery"></div>
									</div>
									<!--end::Section-->
								</div>
								<!--end: Wizard Step 4-->
								...
								<div class="d-flex justify-content-between pt-3">
									...
									<div>
										<button type="submit" id="kt_login_signup_form_submit_button" class="btn btn-primary font-weight-bolder font-size-h6 pl-5 pr-8 py-4 my-3" data-wizard-type="action-submit">
										...
										<button id="action_next" type="button" class="btn btn-primary font-weight-bolder font-size-h6 pl-8 pr-4 py-4 my-3" data-wizard-type="action-next">Next Step
